...
if(file_exists(__DIR__."/../priority.list"))
{
	$priorityFile = trim(file_get_contents(__DIR__."/../priority.list"));
	$priorityNormalised = str_replace("\r\n", "\n", $priorityFile);

	if($priorityFile !== "")
	{
		$priorityServers = explode("\n", $priorityNormalised);
		if($priorityServers[0] === "")
		{
